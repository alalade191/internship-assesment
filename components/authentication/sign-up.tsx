...
const UserSignUp = () => {
  ...
  return (
    <section className="lg:flex h-screen w-full">
      ...
      <div className="h-full lg:w-[30%] w-full bg-white flex flex-col items-center lg:justify-center justify-normal p-[30px]">
        <section className="lg:w-[360px] w-full flex flex-col gap-[30px]">
